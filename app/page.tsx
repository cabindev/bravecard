...
export default function Home() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-pink-100 via-yellow-100 to-blue-100">
      <div className="text-center p-8 rounded-xl max-w-2xl w-full">
        <h1 className="text-5xl sm:text-6xl font-bold text-pink-600 mb-6">การ์ดกล้า</h1>
        <p className="text-xl sm:text-2xl text-gray-700 mb-10">เชื่อมโยงกับคุณภาพดีๆ จากไพ่กล้า</p>
